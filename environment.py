...
class Environment(object):
    ...
    def reset(self, number=0):
        self.done = False
        self.t = 0
        #print "number of runs in env: ", number
        ...
        for agent in self.agent_states.iterkeys():
            ...
            agent.reset(destination=(destination if agent is self.primary_agent else None),num_run=number)
...
class Agent(object):
    ...
    def reset(self, destination=None,num_run=0):
        pass
